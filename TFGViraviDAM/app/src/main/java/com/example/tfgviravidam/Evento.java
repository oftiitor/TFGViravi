...
public class Evento {
    ...
    public Evento(int id, String nombre, String descripcion, File imagen, String direccion, boolean esFavorito, Date fechaInicio, Date fechaFin, ArrayList<Usuario> usuariosApuntados, ArrayList<Usuario> usuarioCreador) {
        this.id = id;
        this.nombre = nombre;
